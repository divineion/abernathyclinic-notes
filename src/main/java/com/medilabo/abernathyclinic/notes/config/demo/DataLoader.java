...
public class DataLoader implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Note testNote3 = new Note(PATIENT_2_UUID, DOCTOR_1_ID, LocalDateTime.of(2025, Month.OCTOBER, 25, 15, 10), null, 
		...
		Note testNote5 = new Note(PATIENT_3_UUID, DOCTOR_2_ID, LocalDateTime.of(2025, Month.FEBRUARY, 25, 14, 40), null, 
		...
		Note testNote7 = new Note(PATIENT_4_UUID, DOCTOR_2_ID, LocalDateTime.of(2023, Month.DECEMBER, 25, 14, 40), null, 
				"Le patient déclare qu'il a mal au dos lorsqu'il reste assis pendant longtemps");
		addIfNotExists(testNote7, notes);
				
		Note testNote8 = new Note(PATIENT_4_UUID, DOCTOR_2_ID, LocalDateTime.of(2024, Month.MAY, 25, 9, 15), null,
		...
		Note testNote9 = new Note(PATIENT_4_UUID, DOCTOR_2_ID, LocalDateTime.of(2025, Month.AUGUST, 18, 14, 40), null, 
	...
	private void addIfNotExists(Note note, List<Note> notes) {
			customRepository.findByPatientUuidAndCreatedAt(note.getPatientUuid(), note.getCreatedAt())
